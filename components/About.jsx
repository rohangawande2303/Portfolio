      ...
      <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
        ...
        <div className="shadow-xl shadow-blue-300 my-8 px-8">
          <p className="py-4 max-w-2xl mx-auto">
            ...
            web developer eager to make my mark in the digital realm. At 23
        ...
        <div className="flex items-center justify-center gap-10">
          {/* Open the resume PDF in a new tab without downloading */}
          {/* <a
            href="/Rohan_Gawande_Resume.pdf" // Link to the file inside the public folder
          ...
          <Link href="/#portfolio">
            <a className="group flex items-center justify-center my-8 bg-blue-500 text-white px-6 py-3 font-bold uppercase rounded-md tracking-wider cursor-pointer">
              my portfolio
